Config { font = "xft:Victor Mono Nerd Font:regular:size=11:antialias=true"
        ...
        , bgColor = "#282c34"
        , fgColor = "#abb2bf"
        , position = Static {xpos = 2564, ypos = 4, width = 2552, height = 24 }
        ...
        , template = "<action=xdotool key super+shift+Return><fc=#c678dd><fn=1>  </fn></fc></action><fc=#5c6370><fn=2>|</fn></fc><fc=#98c379> %UnsafeStdinReader% </fc>}{<fc=#5c6370><fn=2>|</fn></fc><fc=#e06c75> %multicpu% </fc><fc=#5c6370><fn=2>|</fn></fc><fc=#e5c07b> %memory% </fc><fc=#5c6370><fn=2>|</fn></fc><fc=#c678dd> %date% </fc>"
        , commands =
