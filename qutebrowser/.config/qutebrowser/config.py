...
# default is used.
# Type: Directory
c.downloads.location.directory = "~/0-inbox/downloads"
...
# Type: ShellCommand
c.fileselect.folder.command = ["kitty", "ranger", "{}"]
...
# Type: ShellCommand
c.fileselect.single_file.command = ["kitty", "ranger", "{}"]
...
# Type: Padding
c.statusbar.padding = {"top": 1, "bottom": 1, "left": 3, "right": 3}
...
c.url.start_pages = ["https://search.inetol.net"]
