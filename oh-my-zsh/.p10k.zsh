# Generated by Powerlevel10k configuration wizard on 2020-08-13 at 07:21 CEST.
...
() {
  ...
  # Tip:  Override these parameters for ${TOOL} with POWERLEVEL9K_ASDF_${TOOL}_FOREGROUND and POWERLEVEL9K_ASDF_${TOOL}_BACKGROUND.
