...
return function(s)
  ...
  local function header()
    local dashboard_text = wibox.widget({
      markup = helpers.ui.colorize_text("Dashboard -", beautiful.lighter_grey),
    ...
    local function search_box()
      ...
      local search_text = wibox.widget({
        --[[ markup = helpers.ui.colorize_text("Search", beautiful.white), ]]
        align = "center",
        valign = "center",
  ...
  awesome.connect_signal("central_panel::toggle_off", function(scr)
    if scr == s then
