...
local stats_text = wibox.widget({
  ...
  markup = helpers.ui.colorize_text("Stats", beautiful.lighter_grey),
  valign = "center",
...
local function cpu()
  ...
  watch(
    ...
    function(_, stdout)
      ...
      tooltip:set_markup_silently(
        helpers.ui.colorize_text(cpu_value .. "%", "#c1ebff")
      )
  ...
  awful.spawn.easy_async_with_shell(
    ...
    function(stdout)
      ...
      watch([[
        ...
        tooltip:set_markup_silently(
          helpers.ui.colorize_text(temp_value .. "°C", "#a3cdff")
        )
        collectgarbage("collect")
      end)
    end
...
local function hdd()
  ...
  watch(
    ...
    function(_, stdout)
      ...
      tooltip:set_markup_silently(
        helpers.ui.colorize_text(space_consumed .. "%", "#6791c9")
      )
      collectgarbage("collect")
    end
  )
