...
function text_button.state(args)
  ...
  args.text_hover_bg = args.text_hover_bg
    or helpers.color.button_color(args.text_normal_bg, 0.1)
  args.text_press_bg = args.text_press_bg
    or helpers.color.button_color(args.text_normal_bg, 0.2)

  args.text_on_normal_bg = args.text_on_normal_bg or args.text_normal_bg
  args.text_on_hover_bg = args.text_on_hover_bg
    or helpers.color.button_color(args.text_on_normal_bg, 0.1)
  args.text_on_press_bg = args.text_on_press_bg
    or helpers.color.button_color(args.text_on_normal_bg, 0.2)
