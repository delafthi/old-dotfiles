...
function M.config()
  local ok, dap = pcall(function() return require('dap') end)
  ...
  vim.fn.sign_define('DapLogPoint',
                     {text = 'ﯽ ', texthl = 'Todo', linehl = '', numhl = ''})
  ...
  u.map('n', '<Leader>b', '<Cmd>lua require("dap").toggle_breakpoint()<Cr>',
        opts)
  ...
  u.map('n', '<Leader>vi', '<Cmd>lua require("dap.ui.widgets").hover()<Cr>',
        opts)
