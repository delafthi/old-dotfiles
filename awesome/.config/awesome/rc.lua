...
tag.connect_signal('request::default_layouts', function()
  awful.layout.append_default_layouts {
    ...
    awful.layout.suit.tile, twopane, -- awful.layout.suit.tile.left,
...
awful.keyboard.append_global_keybindings {
  ...
  awful.key({modkey, 'Shift'}, 'q', function() awesome.restart() end,
            {description = 'restart awesome', group = 'awesome'}),
  awful.key({modkey, 'Shift'}, 'slash', function()
    hotkeys_popup.show_help(nil, awful.screen.focused())
  end, {description = 'display help', group = 'awesome'}),
  ...
  awful.key({modkey}, 'f', function() awful.spawn(filemanager_cmd) end,
...
awful.keyboard.append_global_keybindings {
  ...
  awful.key({modkey}, 'h', function() awful.tag.incmwfact(-0.03, nil) end,
            {description = 'minmize the master pane', group = 'layout'}),
  awful.key({modkey}, 'l', function() awful.tag.incmwfact(0.03, nil) end,
...
for i = 1, 9 do
  awful.keyboard.append_global_keybindings {
    ...
    end, {description = 'switch tag ', group = 'tag'}), -- Toggle tag display
    awful.key({modkey, 'Shift'}, '#' .. i + 9, function()
      local tag = client.focus.screen.tags[i]
      if tag then client.focus:move_to_tag(tag) end
    end, {description = 'move client tag ', group = 'tag'})
  }
end
awful.keyboard.append_global_keybindings {
  awful.key({modkey, 'Shift'}, 't',
            function() awful.screen.focused().mytaglist.prompt:run() end)
}
...
client.connect_signal('request::default_keybindings', function()
  awful.keyboard.append_client_keybindings {
    ...
    awful.key({modkey}, 'm', function(c) awful.client.setmaster(c) end, {
...
local function set_random_wallpaper(s)
  ...
  local f = io.popen('fd -d 1 --regex ' .. fileending .. ' ' .. wallpaper_path,
                     'r')
  local files = {}
  local length = 0
  local line = 'begin'
...
screen.connect_signal('request::wallpaper',
                      function(s) set_random_wallpaper(s) end)
