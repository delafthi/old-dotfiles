...
theme.border_color_floating = theme.nord1 -- The fallback border color when the client is floating
...
-- Titlebar {{{2
theme.titlebar_fg = theme.fg_normal -- The titlebar foreground (text) color
theme.titlebar_bg = theme.bg_normal -- The titlebar background color
theme.titlebar_fg_normal = theme.titlebar_fg -- The titlebar foreground (text) color
theme.titlebar_bg_normal = theme.titlebar_bg -- The titlebar background color
theme.titlebar_bgimage_normal = nil -- The titlebar background image image
theme.titlebar_bgimage = nil -- The titlebar background image image
theme.titlebar_fg_focus = theme.fg_focus -- The focused titlebar foreground (text) color
theme.titlebar_bg_focus = theme.bg_focus -- The focused titlebar background color
theme.titlebar_bgimage_focus = nil -- The focused titlebar background image image
--[[ theme.titlebar_floating_button_normal = nil -- floating_button_normal
theme.titlebar_maximized_button_normal = nil -- maximized_button_normal
theme.titlebar_minimize_button_normal = nil -- minimize_button_normal
theme.titlebar_minimize_button_normal_hover = nil -- minimize_button_normal_hover
theme.titlebar_minimize_button_normal_press = nil -- minimize_button_normal_hover
theme.titlebar_close_button_normal = nil -- close_button_normal
theme.titlebar_close_button_normal_hover = nil -- close_button_normal_hover
theme.titlebar_close_button_normal_press = nil -- close_button_normal_press
theme.titlebar_ontop_button_normal = nil -- ontop_button_normal
theme.titlebar_sticky_button_normal = nil -- sticky_button_normal
theme.titlebar_floating_button_focus = nil -- sticky_button_normal
theme.titlebar_maximized_button_focus = nil -- maximized_button_focus
theme.titlebar_minimize_button_focus = nil -- minimize_button_focus
theme.titlebar_minimize_button_focus_hover = nil -- minimize_button_focus
theme.titlebar_minimize_button_focus_press = nil -- minimize_button_focus_press
theme.titlebar_close_button_focus = nil -- close_button_focus
theme.titlebar_close_button_focus_hover = nil -- close_button_focus
theme.titlebar_close_button_focus_press = nil -- close_button_focus_press
theme.titlebar_ontop_button_focus = nil -- ontop_button_focus
theme.titlebar_sticky_button_focus = nil -- sticky_button_focus
theme.titlebar_floating_button_normal_active = nil -- floating_button_normal_active
theme.titlebar_floating_button_normal_active_hover = nil -- floating_button_normal_active_hover
theme.titlebar_floating_button_normal_active_press = nil -- floating_button_normal_active_press
theme.titlebar_maximized_button_normal_active = nil -- floating_button_normal_active_press
theme.titlebar_maximized_button_normal_active_hover = nil -- floating_button_normal_active_press
theme.titlebar_maximized_button_normal_active_press = nil -- maximized_button_normal_active_press
theme.titlebar_ontop_button_normal_active = nil -- maximized_button_normal_active_press
theme.titlebar_ontop_button_normal_active_hover = nil -- ontop_button_normal_active_hover
theme.titlebar_ontop_button_normal_active_press = nil -- ontop_button_normal_active_hover
theme.titlebar_sticky_button_normal_active = nil -- sticky_button_normal_active
theme.titlebar_sticky_button_normal_active_hover = nil -- sticky_button_normal_active_hover
theme.titlebar_sticky_button_normal_active_press = nil -- sticky_button_normal_active_press
theme.titlebar_floating_button_focus_active = nil -- sticky_button_normal_active_press
theme.titlebar_floating_button_focus_active_hover = nil -- floating_button_focus_active_hover
theme.titlebar_floating_button_focus_active_press = nil -- floating_button_focus_active_press
theme.titlebar_maximized_button_focus_active = nil -- maximized_button_focus_active
theme.titlebar_maximized_button_focus_active_hover = nil -- maximized_button_focus_active_hover
theme.titlebar_maximized_button_focus_active_press = nil -- maximized_button_focus_active_press
theme.titlebar_ontop_button_focus_active = nil -- maximized_button_focus_active_press
theme.titlebar_ontop_button_focus_active_hover = nil -- ontop_button_focus_active_hover
theme.titlebar_ontop_button_focus_active_press = nil -- ontop_button_focus_active_press
theme.titlebar_sticky_button_focus_active = nil -- sticky_button_focus_active
theme.titlebar_sticky_button_focus_active_hover = nil -- sticky_button_focus_active_hover
theme.titlebar_sticky_button_focus_active_press = nil -- sticky_button_focus_active_hover
theme.titlebar_floating_button_normal_inactive = nil -- floating_button_normal_inactive
theme.titlebar_floating_button_normal_inactive_hover = nil -- floating_button_normal_inactive_hover
theme.titlebar_floating_button_normal_inactive_press = nil -- floating_button_normal_inactive_press
theme.titlebar_maximized_button_normal_inactive = nil -- maximized_button_normal_inactive
theme.titlebar_maximized_button_normal_inactive_hover = nil -- maximized_button_normal_inactive_hover
theme.titlebar_maximized_button_normal_inactive_press = nil -- maximized_button_normal_inactive_press
theme.titlebar_ontop_button_normal_inactive = nil -- ontop_button_normal_inactive
theme.titlebar_ontop_button_normal_inactive_hover = nil -- ontop_button_normal_inactive
theme.titlebar_ontop_button_normal_inactive_press = nil -- ontop_button_normal_inactive
theme.titlebar_sticky_button_normal_inactive = nil -- sticky_button_normal_inactive
theme.titlebar_sticky_button_normal_inactive_hover = nil -- sticky_button_normal_inactive
theme.titlebar_sticky_button_normal_inactive_press = nil -- sticky_button_normal_inactive_press
theme.titlebar_floating_button_focus_inactive = nil -- floating_button_focus_inactive
theme.titlebar_floating_button_focus_inactive_hover = nil -- floating_button_focus_inactive
theme.titlebar_floating_button_focus_inactive_press = nil -- floating_button_focus_inactive_press
theme.titlebar_maximized_button_focus_inactive = nil -- floating_button_focus_inactive_press
theme.titlebar_maximized_button_focus_inactive_hover = nil -- maximized_button_focus_inactive_hover
theme.titlebar_maximized_button_focus_inactive_press = nil -- maximized_button_focus_inactive_press
theme.titlebar_ontop_button_focus_inactive = nil -- ontop_button_focus_inactive
theme.titlebar_ontop_button_focus_inactive_hover = nil -- ontop_button_focus_inactive_hover
theme.titlebar_ontop_button_focus_inactive_press = nil -- ontop_button_focus_inactive_press
theme.titlebar_sticky_button_focus_inactive = nil -- ontop_button_focus_inactive_press
theme.titlebar_sticky_button_focus_inactive_hover = nil -- sticky_button_focus_inactive_hover
theme.titlebar_sticky_button_focus_inactive_press = nil -- sticky_button_focus_inactive_press ]]
...
theme.layoutlist_bg_normal = theme.nord1 -- The default background color
...
theme.taglist_bg_empty = theme.nord1 -- The tag list empty elements background color
theme.taglist_fg_volatile = theme.nord4 -- The tag list volatile elements foreground (text) color
theme.taglist_bg_volatile = theme.nord2 -- The tag list volatile elements background color
...
-- Awesome {{{2
theme.awesome_icon = theme_assets.awesome_icon(theme.wibar_height, theme.nord9, theme.fg_focus) -- The Awesome icon path
